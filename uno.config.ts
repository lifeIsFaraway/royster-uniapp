...
export default defineConfig({
  ...
  theme: {
    colors: {
      ...
      'mobbin-bg': '#F9FAFB',
      'mobbin-card': '#FFFFFF',
      'mobbin-text-main': '#111827',
      'mobbin-text-sub': '#6B7280',
      'mobbin-border': '#E5E7EB',
      'mobbin-black': '#000000',
    },
    borderRadius: {
      // 统一的大圆角
      'mobbin-card': '32rpx', // 约 16px
      'mobbin-card-lg': '48rpx', // 约 24px
      'mobbin-tag': '9999px',
    },
    boxShadow: {
      // 微弱的浅阴影
      'mobbin-sm': '0 2rpx 4rpx 0 rgba(0, 0, 0, 0.03)',
      // hover 时的阴影浮现效果
      'mobbin-hover': '0 20rpx 30rpx -6rpx rgba(0, 0, 0, 0.08)',
    },
    fontSize: {
